%!TEX root = ../main.tex
\begin{abstract}
This thesis focuses on the design and implementation of a \acf{BI} system and a Data Lake for the company UNOX S.p.A., leveraging the technologies provided by the \acf{AWS} platform. The project was developed in a corporate context where rapid and accurate information analysis is crucial to improving operational performance and supporting data-driven strategic decisions.
